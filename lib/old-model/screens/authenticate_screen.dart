...
import 'package:eshop/old-model/utils/email_validator.dart';
import 'package:eshop/old-model/widgets/circular_button.dart';
import 'package:eshop/old-model/widgets/input.dart';
                  ...
                  if (_formKey.currentState.validate()) {
                    if (!await user.signInUser(_email, _password)) {
                      _scaffoldKey.currentState.showSnackBar(
                        SnackBar(
                          content: Text(
                              "Your email and password combination does not match a eshop/old-model account. Please try again."),
                        ),
                      );
                    }
                  }
